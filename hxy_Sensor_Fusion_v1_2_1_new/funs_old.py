...
def draw_process(location, Target_Send_Raw, mapshow): # 利用matplot投影场景地的图和目标
    ...
    id_max = 256
    os.popen("echo 111111111111111111111111111 > 1.txt")
    ...
    while mapshow.value > 0:
        ...
        target_draw = data[4:int(4 + data[2])].reshape(-1, 7)  # np.float64: ID,class,Xw,Yw,Vx,Vy,heading
        # print("target_send: \n", target_draw)
